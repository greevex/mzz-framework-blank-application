<?php
/**
 * $URL: svn://svn.mzz.ru/mzz/trunk/system/modules/fileManager/controllers/fileManagerEditController.php $
 *
 ...
 * @version $Id: fileManagerEditController.php 4197 2010-04-12 06:22:25Z desperado $
*/
...
class fileManagerEditController extends simpleController
{
    ...
    public function checkFilename($name, $file)
    {
        ...
        $criteria->where('folder_id', $file->getFolder()->getId())->where('name', $name);
