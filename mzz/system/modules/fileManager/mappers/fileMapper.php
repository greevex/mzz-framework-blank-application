<?php
/**
 * $URL: svn://svn.mzz.ru/mzz/trunk/system/modules/fileManager/mappers/fileMapper.php $
 *
 ...
 * @version $Id: fileMapper.php 4267 2010-07-09 14:34:11Z desperado $
 */
    ...
    public function searchByPath($path)
    {
        ...
        if (strpos($path, '/') !== false) {
            ...
            if (!is_null($folder)) {
                ...
                $criteria->where('name', $pagename)->where('folder_id', $folder->getId());
