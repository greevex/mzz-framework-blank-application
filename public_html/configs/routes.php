...
$router->addRoute('gallerySelect', new requestRoute('gallery', array('section' => 'gallery', 'action' => 'categoryList')));
$router->addRoute('galleryList', new requestRoute('gallery/:name', array('section' => 'gallery', 'action' => 'list')));
$router->addRoute('galleryShow', new requestRoute('gallery/photo/:photoid', array('section' => 'gallery', 'action' => 'show')));
$router->addRoute('galleryEdit', new requestRoute('gallery/editPhoto/:photoid', array('section' => 'gallery', 'action' => 'editPhoto')));
$router->addRoute('galleryUpload', new requestRoute('gallery/upload', array('section' => 'gallery', 'action' => 'upload')));

$router->addRoute('default', new requestRoute('', array('section' => 'gallery', 'action' => 'categoryList')));
