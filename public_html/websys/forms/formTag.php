<?php
/**
 * $URL: svn://svn.mzz.ru/mzz/trunk/system/forms/formTag.php $
 *
 ...
 * @version $Id: formTag.php 4171 2010-03-30 10:25:49Z desperado $
 */
...
class formTag extends formElement
{
    ...
    {
        $onsubmit = "if (typeof jipWindow != 'undefined' && jipWindow.windowCount > 0) return jipWindow.sendForm(this);";
        if (isset($attributes['onsubmit'])) {
            $attributes['onsubmit'] .= '; ' . $onsubmit;
        } else {
            $attributes['onsubmit'] = $onsubmit;
