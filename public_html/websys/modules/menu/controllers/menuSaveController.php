<?php
/**
 * $URL: svn://svn.mzz.ru/mzz/trunk/system/modules/menu/controllers/menuSaveController.php $
 *
 ...
 * @version $Id: menuSaveController.php 4197 2010-04-12 06:22:25Z desperado $
 */
...
class menuSaveController extends simpleController
{
    protected function getView()
    {
        ...
        if ($item) {
            ...
            $validator->rule('length', 'description', 'Длина описания должна быть от 0 до 512 знаков!', array(0, 512));
            ...
            if ($validator->validate()) {
                ...
                $isJip = $this->request->getBoolean('is_jip', SC_POST);
                $item->setTitle($title);
        ...
        $groups = $this->toolkit->getMapper('user', 'group')->searchAll();

        $this->view->assign('groups', $groups->export());
