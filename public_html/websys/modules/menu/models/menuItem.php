...
abstract class menuItem extends entity
{
    ...
    public function getGroups()
    {
        ...
        return explode(',', parent::getGroups());
    }

    /**
     * Returns true if the user is in the list of groups that are allowed to see a menu item.
     * If no groups are set for an item, then everyone can view the item (for back compatibility).
     *
     * @param user $user
     * @return boolean
     */
    ...
    {
        return $this->getGroups() == null || count(array_intersect($this->getGroups(), $user->getGroups()->keys())) > 0;
    }
