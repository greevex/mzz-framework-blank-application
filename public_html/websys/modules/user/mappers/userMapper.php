<?php
/**
 * $URL: svn://svn.mzz.ru/mzz/trunk/system/modules/user/mappers/userMapper.php $
 *
 ...
 * @version $Id: userMapper.php 4369 2010-11-15 09:08:28Z iLobster $
 */
...
class userMapper extends mapper
{
    ...
    /**
     * Search user by its login and hashed password
     *
     * @param string $login
     * @param string $passwordHash
     * @return user
     */
    public function searchByLoginAndPasswordHash($login, $passwordHash)
    {
        $criteria = new criteria;
        $criteria->where('login', $login)->where('password', $passwordHash);
