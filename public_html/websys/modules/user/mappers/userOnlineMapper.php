<?php
/**
 * $URL: svn://svn.mzz.ru/mzz/trunk/system/modules/user/mappers/userOnlineMapper.php $
 *
 ...
 * @version $Id: userOnlineMapper.php 4039 2009-12-17 10:30:13Z striker $
 */
...
class userOnlineMapper extends mapper
{
    ...
    {
        $allusers = $this->searchAll();
        foreach($allusers as $a_user) {
            if($a_user->getLastActivity() < (time() - 300)) {
                $this->delete($a_user);
            }
        }
        return $allusers;
