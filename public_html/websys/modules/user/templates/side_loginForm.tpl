...
{form action=$form_action method="post"}
    <div>
        ...
        <table border="0" cellpadding="1" cellspacing="0" width="140">
			...
			<tr>
                <td colspan="2">
                    <a href="{url route="default2" module="user" action="register"}">Регистрация</a>
                </td>
            </tr>
            <tr>
                <td colspan="2">
					<a href="{url route="default2" module="user" action="lostPassword"}">{_ lostpassword}</a>
				</td>
            </tr>
            <tr>
                <td>{form->checkbox name="save" id="saveLogin" value="1"} <label for="saveLogin">{_ remember_login}</label></td>
            </tr>
            <tr>
