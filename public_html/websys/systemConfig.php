 ...
 * @version $Id: systemConfig.php 4356 2010-11-10 03:54:10Z striker $
 */
...
class systemConfig
{
    ...
    * @var string
    */
    public static $administratorEmail;
    ...
    {
        self::$pathToSystem = defined("SYSTEM_PATH") ? SYSTEM_PATH : dirname(__FILE__);
